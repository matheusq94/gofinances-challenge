    ...
    async function loadTransactions(): Promise<void> {
      ...
      const transactionsData = response.data.transactions.map(
        (transaction: Transaction): Transaction => {
          transaction.formattedValue = formatValue(transaction.value); // eslint-disable-line no-param-reassign
          transaction.formattedDate = formatDate(transaction.created_at); // eslint-disable-line no-param-reassign
          return transaction;
        },
      );
